...
/*
 * Find sum of all nodes at level K
 ...
 */
 ...
 public class K_SumOfNodesAtLevelK {
    ...
    //Calculate the sum at a given level
    public static void printSumAtLevelK(Node root, int level){
        ...
        while(!queue.isEmpty()){
            ...
            if(currentNode == null){
                //since null is found, next level starts
                currentLevel++;
                System.out.println();
        ...
        System.out.println("sumAtLevel "+ sumAtLevel);
    ...
    public static void main(String[] args) {
        ...
        //calculate sum at level k, using level order traversal.
        printSumAtLevelK(root, 3);
